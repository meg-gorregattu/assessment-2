...
const canWeDeliver = function(zipCode) {
    if (zipCode === 85205 || zipCode === 85204 || zipCode === 85203 || zipCode === 85213 || zipCode === 85206 ) {
...
//rewriting function using the includes method.
...
//Note: To remove whitespace, you use the .trim() method-- I'm unsure how to use it in this case because it's not working for me. 